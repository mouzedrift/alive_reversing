...
{
public:
    static void LoadFromMemory(SaveData* pData, s32 bKillObjects, BaseMap& map);
    static void SaveToMemory(SaveData* pSaveData, BaseMap& map);
    static s16 LoadFromFile(const char_type* name, BaseMap& map);
