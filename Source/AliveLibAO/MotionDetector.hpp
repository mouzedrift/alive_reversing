...
{
public:
    MotionDetectorLaser(ResourceManagerWrapper& resMan, BaseMap& map)
...
{
public:
    MotionDetector(relive::Path_MotionDetector* pTlv, const Guid& tlvId, ResourceManagerWrapper& resMan, BaseMap& map);
    ~MotionDetector();
