    ...
    switch (mChimeLockState)
    {
        ...
        case ChimeLockStates::ePossessed_2:
            ...
            if (!mHasBellSong && !gVoiceCheat)
            {
                ...
                if (Input().IsAnyActuallyHeld(eThrowItem) && !(field_134_pressed & eThrowItem))
                {
                    SetTargetBellIfSpace(3);
                ...
                if (Input().IsAnyActuallyHeld(eHop) && !(field_134_pressed & eHop))
                {
                    SetTargetBellIfSpace(2);
                    field_134_pressed = pressed;
                    return;
                ...
                if (Input().IsAnyActuallyHeld(eDoAction) && !(field_134_pressed & eDoAction))
                {
                ...
                if (Input().IsAnyActuallyHeld(eCrouchOrRoll) && !(field_134_pressed & eCrouchOrRoll))
                {
                ...
                if (Input().IsAnyActuallyHeld(eRight) && !(field_134_pressed & eRight))
                {
                    SetTargetBellIfSpace(3);
                    field_134_pressed = pressed;
                    return;
                ...
                if (Input().IsAnyActuallyHeld(eUp) && !(field_134_pressed & eUp))
                {
                    SetTargetBellIfSpace(2);
                    field_134_pressed = pressed;
                    return;
                ...
                if (Input().IsAnyActuallyHeld(eLeft) && !(field_134_pressed & eLeft))
                {
                    SetTargetBellIfSpace(1);
                    field_134_pressed = pressed;
                    return;
                ...
                if (Input().IsAnyActuallyHeld(eDown) && !(field_134_pressed & eDown))
                {
                    // hit all 3 bells from left to right
                    SetTargetBellIfSpace(1);
                    mHitAllBells = true;
