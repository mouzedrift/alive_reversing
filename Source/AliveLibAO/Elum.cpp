...
void Elum::Spawn(const Guid& tlvInfo, ResourceManagerWrapper& resMan, BaseMap& map)
{
    relive_new Elum(tlvInfo, resMan, map);
}
...
Elum::Elum(const Guid& tlvInfo, ResourceManagerWrapper& resMan, BaseMap& map)
