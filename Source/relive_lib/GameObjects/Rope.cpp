...
void Rope::InitRopeAnimation()
{
    if (GetGameType() == GameType::eAo)
    {
        switch (GetMap().mCurrentLevel)
        {
            ...
            {
                mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::Rope_R1));
            ...
            default:
            {
                mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::Rope_Lines));
    ...
    {
        mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::AE_Rope));
