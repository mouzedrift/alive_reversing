    ...
    : BaseAnimatedWithPhysicsGameObject(0, resMan, map)
{
    ...
    switch (mType)
    {
        ...
        {
            mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::Explosion_Rock));
        ...
        {
            mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::Explosion_Stick));
        ...
        {
            mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::DeathFlare_2));
        ...
        {
            mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::Meat_Gib));
