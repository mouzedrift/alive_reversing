...
{
    mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::BoomMachine_Pipe_DropGrenade));
    mLoadedAnims.push_back(mResMan.LoadAnimation(AnimId::BoomMachine_Pipe_Idle));
}
