...
{
public:
    ParticleBurst(FP xpos, FP ypos, u32 particleCount, FP scale, BurstType type, ResourceManagerWrapper& resMan, BaseMap& map, s32 fineScale = 13, bool bFadeOut = false);
    ~ParticleBurst();
