...
{
public:
    Dove(AnimId animId, const Guid& tlvId, FP scale, ResourceManagerWrapper& resMan, BaseMap& map);
    Dove(AnimId animId, FP xpos, FP ypos, FP scale, ResourceManagerWrapper& resMan, BaseMap& map);
    ~Dove();
