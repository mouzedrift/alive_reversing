    ...
    : BaseAliveGameObject(0)
{
    ...
    field_1D4_previous_input = static_cast<s16>(InputCommands::Enum::eThrowItem);
    ...
    field_1D6_continue_move_input = static_cast<s16>(InputCommands::Enum::eThrowItem);
...
s16 MineCar::FollowDirection()
{
    ...
    )
    {
        ...
        {
            field_1D6_continue_move_input = (u16) InputCommands::Enum::eUp;
        }
        else
        {
            field_1D6_continue_move_input = (u16) InputCommands::Enum::eDown;
        }
    ...
    )
    {
        ...
        {
            field_1D6_continue_move_input = (u16) InputCommands::Enum::eLeft;
        }
        else
        {
            field_1D6_continue_move_input = (u16) InputCommands::Enum::eRight;
        }
...
void MineCar::State_1_ParkedWithAbe()
{
    ...
    InputCommands::Enum inputKey = InputCommands::Enum::eRight;
    ...
    if (
        (
            ...
            (
                ...
                field_1D4_previous_input != (u16) InputCommands::Enum::eLeft &&
                field_1BC_turn_direction != MineCarDirs::eUp_3 &&
    ...
    inputKey = InputCommands::Enum::eLeft;
    ...
    if (
        (
            ...
            (
                Input().IsAnyHeld(field_1D4_previous_input) &&
                (u16) field_1D6_continue_move_input == inputKey &&
                field_1D4_previous_input != (u16) InputCommands::Enum::eRight &&
                field_1BC_turn_direction != MineCarDirs::eUp_3 &&
                field_1BC_turn_direction != MineCarDirs::eDown_0
            )
        ) &&
...
void MineCar::HandleUpDown()
{
    ...
    InputCommands::Enum inputKey = InputCommands::Enum::eUp;
    ...
    if (
        ...
        (
            Input().IsAnyHeld(field_1D4_previous_input) &&
            (u16) field_1D6_continue_move_input == inputKey &&
            field_1D4_previous_input != (u16) InputCommands::Enum::eDown &&
    ...
    inputKey = InputCommands::Enum::eDown;
    ...
    if (
        ...
        (
            Input().IsAnyHeld(field_1D4_previous_input) &&
            (u16) field_1D6_continue_move_input == inputKey &&
            field_1D4_previous_input != (u16) InputCommands::Enum::eUp &&
            field_1BC_turn_direction != MineCarDirs::eLeft_2 &&
            field_1BC_turn_direction != MineCarDirs::eRight_1 &&
            !IsBlocked(MineCarDirs::eUp_3, 0)
        )
