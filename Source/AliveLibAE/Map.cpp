...
void Map::GoTo_Camera()
{
    ...
    Map::Load_Path_Items(field_2C_camera_array[0], relive::Factory::LoadMode::ConstructObject_0);
    ResourceManagerWrapper::LoadingLoop(bShowLoadingIcon);
    Map::Load_Path_Items(field_2C_camera_array[3], relive::Factory::LoadMode::ConstructObject_0);
    Map::Load_Path_Items(field_2C_camera_array[4], relive::Factory::LoadMode::ConstructObject_0);
    Map::Load_Path_Items(field_2C_camera_array[1], relive::Factory::LoadMode::ConstructObject_0);
    Map::Load_Path_Items(field_2C_camera_array[2], relive::Factory::LoadMode::ConstructObject_0);
    ...
    gPathInfo->Loader_4DB800(mCamIdxOnX, mCamIdxOnY, relive::Factory::LoadMode::ConstructObject_0, ReliveTypes::eNone); // none = load all
...
void Map::Load_Path_Items(Camera* pCamera, relive::Factory::LoadMode loadMode)
{
    ...
    if (!pCamera->mCamResLoaded)
    {
        if (loadMode == relive::Factory::LoadMode::ConstructObject_0)
        {
            ...
            gPathInfo->Loader_4DB800(pCamera->mCamXOff, pCamera->mCamYOff, relive::Factory::LoadMode::LoadResourceFromList_1, ReliveTypes::eNone); // none = load all
        }
        else
        {
            ...
            gPathInfo->Loader_4DB800(pCamera->mCamXOff, pCamera->mCamYOff, relive::Factory::LoadMode::LoadResource_2, ReliveTypes::eNone); // none = load all
        }
