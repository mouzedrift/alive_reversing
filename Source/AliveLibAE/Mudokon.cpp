...
Mudokon::Mudokon(relive::Path_Mudokon* pTlv, const Guid& tlvId, ResourceManagerWrapper& resMan, BaseMap& map)
    : BaseAliveGameObject(18, resMan, map)
{
...
bool Mudokon::VTakeDamage(BaseGameObject* pFrom)
{
    switch (pFrom->Type())
    {
        ...
        case ReliveTypes::eFleech:
            ...
            {
                mHealth = FP_FromInteger(0);
                Mudokon_SFX(MudSounds::eHurt1_16, 0, 1000, this, mMap);
                mPersistAndResetOffscreen = false;
                mBrainState = Mud_Brain_State::Brain_5_ShrivelDeath;
                field_194_timer = MakeTimer(90);
    ...
    switch (mBrainSubState)
    {
        ...
        case Brain_0_GiveRings::eBrain0_Chanting_7:
            if (static_cast<s32>(sGnFrame) > field_194_timer)
            {
                ...
                {
                    // Red flicker
                    relive_new PossessionFlicker(this, 10, 255, 128, 128, mResMan, mMap);
                }
                else
                {
                    // Greenish flicker
                    relive_new PossessionFlicker(this, 10, 255, 255, 32, mResMan, mMap);
                }
    ...
    switch (mBrainSubState)
    {
        ...
        case Brain_9_Sick::eBrain9_Idle_1:
            ...
            if (field_180_emo_tbl != Mud_Emotion::eSick_7)
            {
                ...
                mNextMotion = eMudMotions::Motion_0_Idle;
                relive_new PossessionFlicker(this, 8, 155, 255, 32, mResMan, mMap);
        ...
        case Brain_9_Sick::eBrain9_StandingUp_3:
            ...
            if (GetAnimation().GetFlipX())
            {
                New_Smoke_Particles(
                    ...
                    3, RGB16{ 32, 128, 32 }, mResMan, mMap);
            }
            else
            {
                New_Smoke_Particles(
...
void Mudokon::MudEmotionSound(MudSounds idx)
{
    if (!mMap.Is_Point_In_Current_Camera(mCurrentLevel, mCurrentPath, mXPos, mYPos, 0))
    {
        if (field_180_emo_tbl != Mud_Emotion::eSick_7)
        {
            ...
            Mudokon_SFX(idx, 80, field_13C_voice_pitch, this, mMap);
            return;
        }
        ...
        Mudokon_SFX(MudSounds::eSick_24, Math_RandomRange(20, 50), pitch1, this, mMap);

        s16 pitch2 = Math_RandomRange(-5, 0);
        pitch2 *= 100;
        pitch2 = pitch2 - field_13C_voice_pitch;
        Mudokon_SFX(MudSounds::eSadUgh_28, Math_RandomRange(20, 60), pitch2, this, mMap);
        return;
    }
    ...
    if (field_180_emo_tbl == Mud_Emotion::eSick_7)
    {
        if (idx == MudSounds::eSick_24)
        {
            ...
            pitch1 *= 100;
            pitch1 = pitch1 - field_13C_voice_pitch;
            Mudokon_SFX(MudSounds::eSick_24, Math_RandomRange(55, 90), pitch1, this, mMap);

            s16 pitch2 = Math_RandomRange(-5, 0);
            pitch2 *= 100;
            pitch2 = pitch2 - field_13C_voice_pitch;
            Mudokon_SFX(MudSounds::eSadUgh_28, Math_RandomRange(60, 110), pitch2, this, mMap);
            return;
        }
        Mudokon_SFX(idx, 0, field_13C_voice_pitch, this, mMap);
    }
    else
    {
        Mudokon_SFX(idx, 0, field_13C_voice_pitch, this, mMap);
...
void Mudokon::HurtSoundPitchedToHealth()
{
    ...
    Mudokon_SFX(static_cast<MudSounds>(random), bInCamera ? 0 : 80, Math_RandomRange(200 * min, 40 * (5 * min + 5)), this, mMap);
}
